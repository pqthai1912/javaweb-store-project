...
//xử lý các ngoại lệ trên toàn bộ ứng dụng trong một thành phần xử lý chung
@ControllerAdvice
public class ControllerAdvisor {
	...
	public void populateModel(Model model) {	
		...
		if (auth != null && auth.isAuthenticated() && !(auth instanceof AnonymousAuthenticationToken)) {				
			...
			if (user != null) {
				model.addAttribute("shoppingCartItemNumber", shoppingCartService.getItemsNumber(user) ); // hiển thị sản phẩm đã thêm vào giỏ hàng
			}
		} else { 
